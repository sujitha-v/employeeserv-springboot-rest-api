...
public class TestServiceServiceLocator extends org.apache.axis.client.Service implements com.apex.server.TestServiceService {
    ...
    private java.lang.String TestService_address = "http://localhost:8080/SoapServer/services/TestService";
    ...
    public com.apex.server.TestService getTestService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.apex.server.TestServiceSoapBindingStub _stub = new com.apex.server.TestServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.apex.server.TestService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.apex.server.TestServiceSoapBindingStub _stub = new com.apex.server.TestServiceSoapBindingStub(new java.net.URL(TestService_address), this);
                _stub.setPortName(getTestServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://server.apex.com", "TestServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://server.apex.com", "TestService"));
        }
